	...
	<div id="healthForm-one">
		<div class="symptom">
			...
			<div class="healthForm-item">
				...
				<p v-for="(item,index) in symptomList" :data-index="index" :key="item.index" @click="item.checked = !item.checked,cancle($event)"><img :src="item.checked?require('../../../assets/already.png'):require('../../../assets/notyet.png')"  :data-index="index"/><span>{{item.type}}</span></p>
				<div class="other"><span>其他</span><input type="text" :value="otherSymptom" @input="otherSymptom = $event.target.value" placeholder="请输入" /></div>
			</div>
		</div>
		<div class="normal-condition">
			<div class="healthForm-headline"><span style="display: inline-block;">一般状况</span>
				<div @click="importNewData" class="cliect">导入最新检测数据</div>
			</div>
			<div class="fa-box1">
				...
				<div class="normal-condition-input healthservice">
					<div class="unit"><input type="number" :value="temperature" @input="temperature = $event.target.value" placeholder="请输入" class="short"/><span>℃</span></div>
					<div class="check">检测</div>
					<div class="BFC"></div>
					<div class="unit"><input type="tel"  :value="bloodPressure_Diastolic_Left" @input="bloodPressure_Diastolic_Left = $event.target.value" placeholder="收缩压/舒张压" class="short" /><span>mmHg</span></div>
					<div class="check">检测</div>
					<div class="BFC"></div>
					<div class="unit"><input type="tel" :value="bloodPressure_Diastolic_Right" @input="bloodPressure_Diastolic_Right = $event.target.value" placeholder="收缩压/舒张压" class="short" /><span>mmHg</span></div>
					<div class="check">检测</div>
					<div class="BFC"></div>
					<div class="unit"> <input type="number" :value="waistLine" @input="waistLine = $event.target.value" placeholder="请输入" class="short" /><span>cm</span></div>
					<div class="BFC"></div>
					<div class="unit"> <input type="number" :value="height" @input="height = $event.target.value" placeholder="请输入" class="short" /><span>cm</span></div>
					<div class="BFC"></div>
					<div class="unit"> <input type="number" :value="BMI" @input="BMI = $event.target.value" placeholder="请输入" class="short" /><span></span></div>
					<div class="BFC"></div>
				</div>
			</div>
			...
			<div class="fa-box2">
				...
				<div class="normal-condition-input healthservice second-input">
					<div class="unit"><input type="number" :value="pulseRate" @input="pulseRate = $event.target.value" placeholder="请输入" class="short" /><span>次/每分钟</span></div>
					<div class="BFC"></div>
					<input type="number" placeholder="请输入" :value="BMI"  class="hide" />
					<div class="BFC"></div>
					<input type="number" placeholder="请输入" :value="BMI" class="hide" />
					<div class="BFC"></div>
					<div class="unit"><input type="number" :value="breathRate" @input="breathRate = $event.target.value" placeholder="请输入" class="short" /><span>次/每分钟</span></div>
					<div class="BFC"></div>
					<div class="unit"><input type="number" :value="weight" @input="weight = $event.target.value" placeholder="请输入" class="short" /><span>Kg</span></div>
				</div>
			</div>
		...
		<div class="evaluate" v-show="patientAge>=65">
			<div class="evaluate-item">
				...
				<div class="evaluate-item-panel">
					<div :class="healthyStatus==0?'selected':''" data-index="0" @click="healthyStatus=$event.target.dataset.index">
						满意
					</div>
					<div :class="healthyStatus==1?'selected':''" data-index="1" @click="healthyStatus=$event.target.dataset.index">
						基本满意
					</div>
					<div :class="healthyStatus==2?'selected':''" data-index="2" @click="healthyStatus=$event.target.dataset.index">
						说不清楚
					</div>
					<div :class="healthyStatus==3?'selected':''" data-index="3" @click="healthyStatus=$event.target.dataset.index">
						不太满意
					</div>
					<div :class="healthyStatus==4?'selected':''" data-index="4" @click="healthyStatus=$event.target.dataset.index">
						不满意
					</div>
				</div>
			</div>
			<div class="evaluate-item">
				...
				<div class="evaluate-item-panel">
					<div :class="self_help==0?'selected':''" data-index="0" @click="self_help=$event.target.dataset.index">
						可自理
					</div>
					<div :class="self_help==1?'selected':''" data-index="1" @click="self_help=$event.target.dataset.index">
						轻度依赖
					</div>
					<div :class="self_help==2?'selected':''" data-index="2" @click="self_help=$event.target.dataset.index">
						中度依赖
					</div>
					<div :class="self_help==3?'selected':''" data-index="3" @click="self_help=$event.target.dataset.index">
						不能自理
					</div>
				</div>
			</div>
			<div class="evaluate-item">
				...
				<div class="evaluate-item-panel">
					<div :class="cognitive==0?'selected':''" data-index="0" @click="cognitive=$event.target.dataset.index">
						粗筛阴性
					</div>
					<div :class="cognitive==1?'selected':''" data-index="1" @click="cognitive=$event.target.dataset.index">
						粗筛阳性
					</div>
				</div>
			</div>
			<div class="evaluate-item">
				...
				<div class="evaluate-item-panel">
					<div :class="affective==0?'selected':''" data-index="0" @click="affective=$event.target.dataset.index">
						粗筛阴性
					</div>
					<div :class="affective==1?'selected':''" data-index="1" @click="affective=$event.target.dataset.index">
						粗筛阳性
					</div>
				</div>
			</div>
...
//					data.resultList.map(function(item,index){
//						if(item.value){
//						return vm.showtoast('导入成功');
//						}
//					})
			for(var i=0;i<data.resultList.length;i++){
				if(data.resultList[i].value){
					return vm.showtoast('导入成功');
				}
					}
					vm.showtoast('暂无数据');
			...
			cancle(event){	
				if(event.target.dataset.index!=0){
					console.log(event)
					this.symptomList[0].checked = false;
				}
				else{
					this.symptomList.map(function(item,index){
						if(index !=0){
							item.checked = false
						}
					})
			...
			initData(){
				let vm = this;
				let symptomList = [];
//				console.log(vm.NotEmpty(undefined));				
				...
				vm.generalSituation.bloodPressure_Diastolic_Left?vm.generalSituation.bloodPressure_Diastolic_Left=vm.generalSituation.bloodPressure_Diastolic_Left+'/':vm.generalSituation.bloodPressure_Diastolic_Left=vm.generalSituation.bloodPressure_Diastolic_Left;
				vm.bloodPressure_Diastolic_Left = vm.NotEmpty(vm.generalSituation.bloodPressure_Diastolic_Left)+vm.NotEmpty(vm.generalSituation.bloodPressure_Systolic_Left);
				vm.bloodPressure_Systolic_Left = vm.generalSituation.bloodPressure_Systolic_Left;
				vm.generalSituation.bloodPressure_Diastolic_Right?vm.generalSituation.bloodPressure_Diastolic_Right = vm.generalSituation.bloodPressure_Diastolic_Right+'/':vm.generalSituation.bloodPressure_Diastolic_Right=vm.generalSituation.bloodPressure_Diastolic_Right;
				vm.bloodPressure_Diastolic_Right = `${vm.NotEmpty(vm.generalSituation.bloodPressure_Diastolic_Right)}${vm.NotEmpty( vm.generalSituation.bloodPressure_Systolic_Right)}`;
...
//				console.log(generalSituation);
		...
		created() {
			...
			vm.initData();
		console.log(vm.generalSituation);
		},
		mounted() {}
	}
</script>
