<template>
  <div class="diabetesList healthservice"> 
  	<div class="left">
  		<ul class="left-list">
...
export default {
  ...
  methods:{
  	gotofollow:function(tex,id){
  		var vm = this;
  		var _id = id||'';
  		window.location.href = 'diabetes.html?type='+tex+'&id='+_id;
  	},
  	initialize:function(){
  		var vm = this;
  		setTimeout(function(){
...
.diabetesList .left .item.on{
	background: #3C9BFF;
	color: #fff;
}
.diabetesList-content{
	display: inline-block;
	width: 83.2%;
	vertical-align: text-top;
	height: 100%;
