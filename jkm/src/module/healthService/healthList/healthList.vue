<template>
  <div class="healthList healthservice">
  	<div class="left">
  		<ul class="left-list">
  			<li class="left-item item" @click.stop="gototaburl('个人档案')">个人档案</li>
  			<li class="left-item item on" @click.stop="gototaburl('健康体检表')">健康体检表</li>
  			<li class="left-item item" v-if="ishighBP" @click.stop="gototaburl('高血压随访')">高血压随访</li>
  	...
  	</div><div class='healthList-content'>
...
export default {
  ...
  methods:{
  	gotoform:function(tex,id){
  		var vm = this;
  		var _id = id||'';
  		window.location.href = 'healthForm.html?type='+tex+'&id='+_id;
  	},
  	initialize:function(){
  		var vm = this;
  		setTimeout(function(){
